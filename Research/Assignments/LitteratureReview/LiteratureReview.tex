...
\section{Information}
The literature review is divided into different areas that can be found as titles in this paper.
...
One issue with VR is the text-input Performance. The reason is that two hand controllers are usually used with a VR headset. This results in limited movement. One study explore select base typing as an allternetive to keyboard input \cite{speicher_selection-based_2018}

\subsection{Motion Sickness}
\subsubsection{Simulation Sickness}
